	...
	<div class="container">
		<div class="twelve columns">
			<ul class="share">
				...
				<li class="twitter">
					<a href="https://twitter.com/share" class="twitter-share-button" data-via="infocongo" data-lang="<?php if(function_exists('qtrans_getLanguage')) echo qtrans_getLanguage(); ?>">Tweet</a>
				</li>
				<li class="share">
					<a class="button share-button" href="<?php echo jeo_get_share_url(array('map_id' => $post->ID)); ?>"><?php _e('Embed this map', 'infocongo'); ?></a>
				</li>
			</ul>
	...
	if(have_posts()) : ?>
        ...
        <section id="last-stories" class="loop-section">
            <div class="section-title">
                <div class="container">
                    <div class="twelve columns">
                        <h3><?php _e('Stories on', 'infocongo'); ?> &ldquo;<?php the_title(); ?>&ldquo;</h3>
