...
<div class="mapgroup-container">
	<div id="mapgroup_<?php echo jeo_get_the_ID(); ?>" class="mapgroup">
		<ul class="map-nav">
			...
			<?php if($more_maps) : ?>
				<li class="more-tab">
					<a href="#" class="toggle-more"><?php _e('More...', 'infocongo'); ?></a>
					<ul class="more-maps-list">
						...
						?>
						<li><a href="<?php echo $link; ?>"><?php _e('View all maps', 'infocongo'); ?></a></li>
					</ul>
				</li>
			<?php endif; ?>
		</ul>
		<?php if(!is_single()) : ?>
			<div class="map-sidebar">
				...
				<?php
				if(is_home() && !is_paged() && !$_REQUEST['infocongo_filter_'])
